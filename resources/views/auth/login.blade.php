...
{{--                                <input type="email" class="form-control" placeholder="Email">--}}
                                ...
                                <x-jet-input id="email" class="form-control" type="email" placeholder="Enter Email" name="email" :value="old('email')" required autofocus />
                        ...
                        <div class="input-group mb-3">
                            <x-jet-input id="password" class="form-control" type="password" name="password" placeholder="Enter password" required autocomplete="current-password" />
                            <div class="input-group-append">
                                <div class="input-group-text">
...
{{--                            </div>--}}
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <x-jet-button class="bg-primary ml-7">
                                    {{ __('Log in') }}
                                </x-jet-button>
                            </div>
                            <!-- /.col -->
